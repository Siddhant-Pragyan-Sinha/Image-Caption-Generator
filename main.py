...
import os
os.environ['TF_CPP_MIN_LOG_LEVEL'] = '2' #REMOVE THIS LINE OF CODE IF YOU HAVE A GPU CONNECTED TO YOUR SYSTEM
...
dataset_text = os.path.join(base_dir, "Flickr8k_text")
dataset_images = os.path.join(base_dir, "Flickr8k_Dataset", "Flicker8k_Dataset")
